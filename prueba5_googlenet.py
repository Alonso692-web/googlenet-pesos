...
# --- Interfaz Tkinter ---
BASE_FONT_SIZE = 22   # Tamaño base que usaremos para la fuente por defecto
...
# El placeholder “Imagen” usará la fuente por defecto (ya mayor por named font),
# pero lo hacemos un poco más grande y en negrita:
...
# Etiqueta para mostrar la etapa clasificada: un poco más grande y en negrita
stage_label = tk.Label(
    right_frame,
    text='',
    fg='blue',
    font=tkfont.Font(size=BASE_FONT_SIZE + 4, weight='bold'),
    anchor='nw',
    justify=tk.LEFT
)
...
# Los botones heredarán la fuente por defecto (agrandada). Si quieres negrita en “Tomar Foto”:
capture_btn = tk.Button(
    button_frame,
    text='Tomar Foto',
    font=tkfont.Font(size=BASE_FONT_SIZE, weight='bold'),
...
clear_btn = tk.Button(
    button_frame,
    text='Limpiar',
    font=tkfont.Font(size=BASE_FONT_SIZE),
